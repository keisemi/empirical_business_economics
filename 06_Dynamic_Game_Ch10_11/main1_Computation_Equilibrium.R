...
# 行列を作成
mat <- matrix(c(CCP1UpdatedMat, CCP2UpdatedMat), ncol = 6)

# コンソールに出力
print(mat)

# CSVに書き出し
write.csv(mat, file = here("06_Dynamic_Game_Ch10_11/output/Sec_10_3_2_Equilibrium_CCP.csv"), 
          row.names = TRUE, 
          col.names = c("a1 = -1", "a1 = 0", "a1 = 1", "a2 = -1", "a2 = 0", "a2 = 1" ))
...
# 変数`FakeData`がOutputとなる。
write.csv(FakeData, file = here("06_Dynamic_Game_Ch10_11/output/FakeData_R.csv"))
