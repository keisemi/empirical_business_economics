...
CCP1 = 0.5*ones(8,1);
CCP2 = 0.5*ones(8,1);
% ただし、この行列は同じ確率である必要はなく、例えば以下のような行列でも
% 構わない
% CCP1 = [ .5 .55 .6 .65 .4 .6 .45 .55 ]';
% CCP2 = [ .5 .6 .55 .65 .4 .45 .6 .55 ]';
...
disp('均衡におけるCCP')
disp( [CCP1UpdatedMat CCP2UpdatedMat] )
...
InitialState  = randi([1 8],NumSimMarkets,1);
...
% 4: 状態変数の要素である景気状態
% 5: 状態変数の要素である景気状態 n_{1,t}
% 6: 状態変数の要素である景気状態 n_{2,t}
% 7: 生成された企業1の行動 a_{1,t}
% 8: 生成された企業2の行動 a_{2,t}

for m = 1:NumSimMarkets
