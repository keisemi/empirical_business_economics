...
png("06_Dynamic_Game_Ch10_11/output/ProbEntry1Orginal.png")
par(mfrow = c(1, 2))
plot(1:NumSimPeriods, n1,
  type = "l", xlim = c(1, 15), ylim = c(0, 0.8),
...
# par(mfrow=c(1,2))関数を使用して2つのプロットを並べる
png("06_Dynamic_Game_Ch10_11/output/ProbEntry2Original.png")
par(mfrow = c(1, 2))
plot(1:NumSimPeriods, n1,
  type = "l", xlim = c(1, 15), ylim = c(0, 0.8),
  xaxp = c(1, 15, 14), xaxt = "n", main = "企業1の店舗存在確率", xlab = "", ylab = ""
