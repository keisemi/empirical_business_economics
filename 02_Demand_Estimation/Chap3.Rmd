...
# 結果のアウトプット
tbl_ols_intro <- fixest::etable("OLS_NIPPYO" = ols_intro, 
                                se = "hetero",
                                signif.code = NA, 
                                fitstat = c("r2", "n" ), 
...
tbl_ols_intro %>%
  ...
  kable_styling(full_width = FALSE) %>%
  save_kable("output/chap3_ols_intro.tex")
```
...
tbl_data_summary %>%
  kable(align = c("l", rep("c", 7)),
        digits = 2,
        booktabs = FALSE, format = "latex") %>%
  kable_styling(full_width = FALSE) %>%
  save_kable("output/chap3_data_summary.tex")
```
...
# 推定結果をレポートする。
tbl_logit_iv <- fixest::etable(list("OLS" = ols, "iv_BLP" = iv_BLP, "iv_GH" = iv_GH),  
                               se = "hetero",
                               fitstat = c("r2", "n", "ivf" ), 
                               signif.code = NA, 
                               dict = c(price = "自動車価格",
...
tbl_logit_iv %>%
  kable(align = c("l", "c", "c", "c"),
        booktabs = FALSE, format = "latex") %>%
  kable_styling(full_width = FALSE) %>%
  save_kable("output/chap3_logit_iv.tex")
```
...
# 推定結果をレポートする。
tbl_logit_iv_1st <- fixest::etable(list("iv1st_BLP" = iv1st_BLP, "iv1st_GH" = iv1st_GH),  
                                   se = "hetero",
                                   fitstat = c("r2", "n"), 
                                   signif.code = NA, 
                                   dict = c(price = "自動車価格",
...
tbl_logit_iv_1st %>%
  kable(align = c("l", "c", "c"),
        booktabs = FALSE, format = "latex") %>%
  kable_styling(full_width = FALSE) %>%
  save_kable("output/chap3_logit_iv_1st.tex")
```
...
tbl_own_elas %>%
  kable(align = c("l", rep("c", 5)),
        ...
        booktabs = FALSE, format = "latex") %>%
  kable_styling(full_width = FALSE) %>%
  save_kable("output/chap3_own_elas.tex")
```
