...
kable(Table_7dt1, align = rep('c', 3), 
      booktabs = TRUE, format = "html",
...
# 表を作る
kable(Table_7dt2, align = rep('c', 5),
      booktabs = TRUE, format = "html",
...
kable(Table_7dt3, align = rep('c', 3),
      booktabs = TRUE, format = "html",
...
# 表を作る
kable(Table_7dt4, align = rep('c', 5),
      booktabs = TRUE, format = "html",
      caption = "Change in Profits and Revenues") %>%
  add_header_above(c(" ", "Nippyo and Brand A" = 2, "Nippyo and Brand B" = 2)) %>%
  kable_styling(full_width = FALSE)
